...
func addNumericPage(_ defaultKeyboard: Keyboard)
{
    ...
    if UserDefaults.standard.bool(forKey: kQuickSwitch) == true {
        AddCharacters(defaultKeyboard, characters: ["-","/", ":", ";", "(", ")", "$", "&", "@","\""], row: 1, page: 1)
        defaultKeyboard.addKey(Key.ModeChangeSpecialChars(), row: 2, page: 1)
        AddCharacters(defaultKeyboard, characters: [".", ",", "?", "!", "\'"], row: 2, page: 1)
...
func addSymbolsPage(_ defaultKeyboard: Keyboard)
{
    ...
    AddSpecialCharacters(defaultKeyboard, characters: ["-", "\\", "|", "~", "<", ">", "\u{20AC}", "\u{00A3}", "\u{00A5}"], row: 1, page: 2)
